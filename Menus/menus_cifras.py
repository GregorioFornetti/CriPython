        ...
        if evento == 'encriptar' or evento == 'traduzir':
            for opção, criptografar in dicionario_funções_cifras.items():
                if valores[opção]:  # Verificar a opção escolhida pelo usuário e executar a função referente a ela (armazenada no dicionário).
                    lista_chaves = []
                    for nome_item, chave_cifra in valores.items():  # Loop para procurar as chaves utilizadas (já que alguns modos utilizam mais que 1)
                        if 'chave' in nome_item:
                            lista_chaves.append(chave_cifra)
                    print(lista_chaves)
...
def menu_cifra_de_cesar_encriptação(tela_anterior):
    ...
    executar_tela_cifra('Cifra de César (encriptação)', tela_anterior, dicionario_funções_cesar_encript, layout_cifra_de_cesar_encript)
...
def menu_cifra_de_cesar_tradução(tela_anterior):
    ...
    executar_tela_cifra('Cifra de César (tradução)', tela_anterior, dicionario_funções_cesar_traduc, layout_cifra_de_cesar_traduc)
...
def menu_subst_simples_encriptação(tela_anterior):
    ...
    executar_tela_cifra('Substituição simples (encriptação)', tela_anterior, dicionario_funções_subst_encript, layout_subst_simples_encript)
...
def menu_subst_simples_tradução(tela_anterior):
    ...
    executar_tela_cifra('Substituição simples (tradução)', tela_anterior, dicionario_funções_subst_traduc, layout_subst_simples_traduc)
...
def menu_cifra_de_vigenere_encriptação(tela_anterior):
    ...
    executar_tela_cifra('Cifra de Vigenère (encriptação)', tela_anterior, dicionario_funções_vigenere_encript, layout_cifra_de_vigenere_encript)
...
def menu_cifra_de_vigenere_tradução(tela_anterior):
    ...
    executar_tela_cifra('Cifra de Vigenère (tradução)', tela_anterior, dicionario_funções_vigenere_traduc, layout_cifra_de_vigenere_traduc)